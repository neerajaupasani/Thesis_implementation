...
class Wiki:
    def loading_file(self):
        ...
        node_df.to_csv(r'wiki_node_vocab.csv',index=False)
    ...
    def cosine_mat(self, cosine_threshold = None):
        ...
        cos_df.to_csv(r'cos_matrix_wiki.csv')
    ...
    def jaccard_mat(self, jaccard_threshold = None):
        ...
        jac_df.to_csv(r'jac_matrix_wiki.csv')
    ...
    def lhn1_mat(self, lhn1_threshold = None):
        ...
        lhn1_df.to_csv(r'lhn1_matrix_wiki.csv')
    ...
    def co_occurrence_mat(self):
        ...
        coo_df.to_csv(r'coo_matrix_wiki.csv')
...
obj.pmi_mat(-2.5)
obj.run_svd_pmi('wiki_node_vocab.csv',128,'wiki_pembed.csv')
obj.run_svd_cosine('wiki_node_vocab.csv',128,'wiki_cembed.csv')
obj.run_svd_jaccard('wiki_node_vocab.csv',128,'wiki_jembed.csv')
obj.run_svd_lhn1('wiki_node_vocab.csv',128,'wiki_lembed.csv')
