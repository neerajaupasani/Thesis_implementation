...
# Loading the respective embeddings(cosine, jaccard, lhn1, and pmi)
...
model4 = pd.read_csv("cora_sembed.csv", header=None)
model5 = pd.read_csv("cora_hembed.csv", header=None)
model6 = pd.read_csv("cora_dembed.csv", header=None)
...
#building the embedding matrix from the pmi-embedding matrix from node 0 to N. ## Still working on it.
