...
class Eval:
    ...
    def pmi_classification(self,embeddings, label_path, name, similarity, threshold):
        ...
        f_c=open('wiki_nc_pmi_%s.txt' % threshold, 'w+')
    ...
    def link_prediction_pmi(self, edge_file, embeddings, size, name, similarity, threshold):
            ...
            f_l = open('wiki_lp_pmi_%s.txt' % threshold, 'w+')
...
eval.pmi_classification(embeddings=embeddings3,label_path='wiki-label.txt',name='Wiki', similarity='pmi', threshold='alpha 15.0')
...
eval.link_prediction_pmi('wiki-edgelist.txt',embeddings=embeddings3,size=128,name='Wiki', similarity='pmi', threshold='alpha 15.0')
