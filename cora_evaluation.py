...
from cora_classification import embeddings,embeddings1,embeddings2, embeddings3, embeddings4, embeddings5, embeddings6
import cora_lp
...
class Eval:
    ...
    def link_prediction_cosine(self, edge_file, embeddings, size, name, similarity, threshold):
            ...
            f_l = open('cora_lp_cosine_%s.txt' % threshold, 'w')
    ...
    def link_prediction_jaccard(self, edge_file, embeddings, size, name, similarity, threshold):
            ...
            f_l = open('cora_lp_jaccard_%s.txt' % threshold, 'w+')
    ...
    def link_prediction_lhn1(self, edge_file, embeddings, size, name, similarity, threshold):
            ...
            f_l = open('cora_lp_lhn1_%s.txt' % threshold, 'w+')
    ...
    def link_prediction_sorensen(self, edge_file, embeddings, size, name, similarity, threshold):
        ...
        f_l = open('cora_lp_sorensen_%s.txt' % threshold, 'w+')
    ...
    def link_prediction_hpi(self, edge_file, embeddings, size, name, similarity, threshold):
        ...
        f_l = open('cora_lp_hpi_%s.txt' % threshold, 'w+')
    ...
    def link_prediction_hdi(self, edge_file, embeddings, size, name, similarity, threshold):
        ...
        f_l = open('cora_lp_hdi_%s.txt' % threshold, 'w+')
...
eval = Eval()
eval.cosine_classification(embeddings=embeddings,label_path='cora-label.txt',name='Cora', similarity='cosine', threshold='alpha 0.8')
eval.jaccard_classification(embeddings=embeddings1,label_path='cora-label.txt',name='Cora', similarity='jaccard', threshold='alpha 0.8')
eval.lhn1_classification(embeddings=embeddings2,label_path='cora-label.txt',name='Cora', similarity='lhn1', threshold='alpha 0.8')
eval.sorensen_classification(embeddings=embeddings4,label_path='cora-label.txt',name='Cora', similarity='sorensen', threshold='alpha 0.8')
eval.hpi_classification(embeddings=embeddings5,label_path='cora-label.txt',name='Cora', similarity='hpi', threshold='alpha 0.8')
eval.hdi_classification(embeddings=embeddings6,label_path='cora-label.txt',name='Cora', similarity='hdi', threshold='alpha 0.8')
...
eval.link_prediction_cosine('cora-edgelist.txt',embeddings=embeddings,size=128,name='Cora', similarity='cosine', threshold='alpha 0.8')
eval.link_prediction_jaccard('cora-edgelist.txt',embeddings=embeddings1,size=128,name='Cora', similarity='jaccard', threshold='alpha 0.8')
eval.link_prediction_lhn1('cora-edgelist.txt',embeddings=embeddings2,size=128,name='Cora', similarity='lhn1', threshold='alpha 0.8')
eval.link_prediction_sorensen('cora-edgelist.txt',embeddings=embeddings4,size=128,name='Cora', similarity='sorensen', threshold='alpha 0.8')
eval.link_prediction_hpi('cora-edgelist.txt',embeddings=embeddings5,size=128,name='Cora', similarity='hpi', threshold='alpha 0.8')
eval.link_prediction_hdi('cora-edgelist.txt',embeddings=embeddings6,size=128,name='Cora', similarity='hdi', threshold='alpha 0.8')
