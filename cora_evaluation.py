...
class Eval:
    ...
    def pmi_classification(self,embeddings, label_path, name, similarity, threshold):
        ...
        f_c=open('cora_nc_pmi.txt' % threshold, 'w+')
    ...
    def link_prediction_pmi(self, edge_file, embeddings, size, name, similarity, threshold):
            ...
            f_l = open('wiki_lp_pmi_%d.txt' % threshold, 'w+')
...
eval.pmi_classification(embeddings=embeddings3,label_path='cora-label.txt',name='Cora', similarity='pmi', threshold='alpha -2.5')
...
eval.link_prediction_pmi('cora-edgelist.txt',embeddings=embeddings3,size=128,name='Cora', similarity='pmi', threshold='alpha -2.5')
