...
class Citeseer:
    def loading_file(self):
        ...
        node_df.to_csv(r'cite_node_vocab.csv',index=False)
    ...
    def print_walks(self):
        global walks
        with open('cite_corpus.txt', 'w+') as f:
            for item in walks:
                f.write(str(item))
    ...
    def print_pairs(self):
        ...
        remove_dupl.to_csv(r'cite_statistics.csv', index = False)
    ...
    def cosine_mat(self, cosine_threshold = None):
        ...
        cos_df.to_csv(r'cos_matrix_cite.csv')
    ...
    def jaccard_mat(self, jaccard_threshold = None):
        ...
        jac_df.to_csv(r'jac_matrix_cite.csv')
    ...
    def lhn1_mat(self, lhn1_threshold = None):
        ...
        lhn1_df.to_csv(r'lhn1_matrix_cite.csv')
    ...
    def co_occurrence_mat(self):
        ...
        coo_df.to_csv(r'coo_matrix_cite.csv')
    ...
    def run_svd_pmi(self, input, dimension, output):
        global co_occur
        ...
        pd.DataFrame(u).to_csv(output, header=None, index=False, float_format='%8.7f', sep=',')
    ...
    def run_svd_cosine(self, input, dimension, output):
        global cosine
        cora_df = pd.read_csv(input)
    ...
    def run_svd_jaccard(self, input, dimension, output):
        global jaccard
        cora_df = pd.read_csv(input)
    ...
    def run_svd_lhn1(self, input, dimension, output):
        global lhn1
        cora_df = pd.read_csv(input)
...
obj.pmi_mat(-2.5)
obj.run_svd_pmi('cite_node_vocab.csv',128,'cite_pembed.csv')
obj.run_svd_cosine('cite_node_vocab.csv',128,'cite_cembed.csv')
obj.run_svd_jaccard('cite_node_vocab.csv',128,'cite_jembed.csv')
obj.run_svd_lhn1('cite_node_vocab.csv',128,'cite_lembed.csv')
