...
# Loading the respective embeddings(cosine, jaccard, lhn1, pmi, sorensen, hpi, and hdi)

model = pd.read_csv("cite_cembed.csv", header=None)
model1 = pd.read_csv("cite_jembed.csv", header=None)
model2 = pd.read_csv("cite_lembed.csv", header=None)
model3 = pd.read_csv("cite_pembed.csv", header=None)
model4 = pd.read_csv("cite_sembed.csv", header=None)
model5 = pd.read_csv("cite_hembed.csv", header=None)
model6 = pd.read_csv("cite_dembed.csv", header=None)
...
#building the embedding matrix from the lhn1-embedding matrix from node 0 to N.
...
#building the embedding matrix from the sorensen-embedding matrix from node 0 to N.
